#!/usr/bin/env node
/**
 * Applica il delta ATOMICO N4 Livello 8 ai repository (append/merge per-id).
...
const DELTA=di>=0?args[di+1]:"delta-n4-l8";
...
// levels (optional — skip if delta.levels.json absent, e.g. L8 when 7–12 already exist)
{
...
console.log((dry?"[DRY-RUN] ":"")+"delta atomico N4-L8:");
