#!/usr/bin/env node
/**
 * Applica il delta ATOMICO N4 Livello 9 ai repository (append/merge per-id).
...
const DELTA=di>=0?args[di+1]:"delta-n4-l9";
...
console.log((dry?"[DRY-RUN] ":"")+"delta atomico N4-L9:");
